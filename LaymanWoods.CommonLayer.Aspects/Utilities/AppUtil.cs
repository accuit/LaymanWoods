...
namespace ECommerce.CommonLayer.Utilities
{
    public static class AppUtil
    {
        ...
        /// <param name="imageType">image type</param>
        /// <returns>returns fully qualified image url</returns>
        public static string GetAPKDownloadURL(string apkVersion, string apkFileName)
        {

            string rawURL = GetAppSettings(AspectEnums.ConfigKeys.APKDownloadURL);
            return String.Format(rawURL, apkVersion, apkFileName);
        }
