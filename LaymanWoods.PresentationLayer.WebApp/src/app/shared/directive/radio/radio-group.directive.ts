...
import { AfterContentInit, ChangeDetectionStrategy, Component, ContentChildren, EventEmitter, Input, OnDestroy, Output, QueryList, Directive } from '@angular/core';
import { Subject } from 'rxjs';
import { takeUntil } from 'rxjs/operators';
import { ElementBaseComponent } from '../../components/element.base/element.base.component';
import { IpxRadioButtonComponent, IChangeRadioEventArgs } from '../../components/radio-button/ipx-radio-button.component';

let nextId = 0;

@Directive({
  selector: 'ipx-radio-button-group, [ipxRadioButtonGroup]'
})

export class IpxRadioButtonGroupDirective extends ElementBaseComponent implements AfterContentInit, OnDestroy {
